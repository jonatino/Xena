...
object EngineOffsets {
	...
	fun load() {
		...
		m_dwClientState = byPattern(engineModule(), 0x1, 0x0, PatternScanner.READ or PatternScanner.SUBTRACT, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x33, 0xD2, 0x6A, 0x0, 0x6A, 0x0, 0x33, 0xC9, 0x89, 0xB0)
		m_dwInGame = byPattern(engineModule(), 0x2, 0x0, PatternScanner.READ, 131, 185, 0x00, 0x00, 0x00, 0x00, 6, 15, 148, 192, 195)
