...
object ClientOffsets {
	...
	fun load() {
		...
		dwLocalPlayer = byPattern(clientModule(), 0x1, 0x10, PatternScanner.READ or PatternScanner.SUBTRACT, 0xA3, 0x00, 0x00, 0x00, 0x00, 0xC7, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x59, 0xC3, 0x6A, 0x00)
		...
		dwLocalPlayer = 0xCB3694L.toInt()
		dwEntityList = 0x4CC36D4L.toInt()
	}
